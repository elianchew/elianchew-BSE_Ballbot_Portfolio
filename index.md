# Ball Tracking Robot
The ball tracking robot uses a Pi camera and ultrasonic sensors to locate the ball. The robot uses motors to follow or intercept the ball while maintaining a set distance. The proportional control, wiring, and computer vision make it complex and challenging.
...
| H-Bridge Motor Drive | Controls the direction and speed of the DC Motors | $20.51 | <a href="https://www.amazon.sg/VKLSVAN-Channel-H-Bridge-Stepper-Controller/dp/B0DQPRDHSK"> Link </a> |
...
| Ultrasonic Sensor | Measures the distance to obstacles to prevent the robot from colliding | $25.35 | <a href="https://www.amazon.sg/dp/B0CQCCGXCP?ref=ppx_yo2ov_dt_b_fed_asin_title"> Link </a> |
